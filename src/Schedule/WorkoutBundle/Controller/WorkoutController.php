...
use Schedule\WorkoutBundle\Form\WorkoutType;
...
class WorkoutController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScheduleWorkoutBundle:Workout')->findAll();
     ...
     * @Method("POST")
     * @Template("ScheduleWorkoutBundle:Workout:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScheduleWorkoutBundle:Workout')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ScheduleWorkoutBundle:Workout:edit.html.twig")
     */
