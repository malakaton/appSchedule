...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b41828333cf58d34b12f97ebac87b7fc');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b41828333cf58d34b12f97ebac87b7fc');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b41828333cf58d34b12f97ebac87b7fc');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Schedule/WorkoutBundle/Entity'))), 'Schedule\\WorkoutBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ScheduleWorkoutBundle' => 'Schedule\\WorkoutBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '324n32j4n242nndfndono324no2n432ndfnlsfsdf');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Schedule/WorkoutBundle/Resources/views'), 'ScheduleWorkout');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('324n32j4n242nndfndono324no2n432ndfnlsfsdf');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ScheduleWorkoutBundle' => 'Schedule\\WorkoutBundle\\ScheduleWorkoutBundle',
            ...
            'locale' => 'en',
            'secret' => '324n32j4n242nndfndono324no2n432ndfnlsfsdf',
            ...
            'kernel.secret' => '324n32j4n242nndfndono324no2n432ndfnlsfsdf',
